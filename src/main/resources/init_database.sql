...
insert into dubhe_user(user_id,user_account,user_password,user_name,delete_flag,version) values(1,'admin','123456','管理员','0','0');

DROP TABLE IF EXISTS dubhe_user;
CREATE TABLE dubhe_depart (
  depart_id BIGINT (11) NOT NULL ,
  depart_name VARCHAR (100) DEFAULT NULL,
  partent_depart_id BIGINT (11) NOT NULL ,
  delete_flag INT(1) DEFAULT NULL,
  version INT (32) DEFAULT NULL,
  create_datetime datetime DEFAULT NULL,
  create_user_id BIGINT (11) DEFAULT NULL,
